package edu.ucsb.cs56.w15.drawings.jazariethach.simple;
...
/**
   ...
   @author Jazarie Thach (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Jazarie Thach", 20,40);
    }
